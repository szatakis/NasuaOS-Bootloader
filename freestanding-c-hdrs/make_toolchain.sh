 ...
 * NasuaOS-Bootloader
 *
 * Copyright (C) 2026 Szataki
 *
 * This file is part of NasuaOS-Bootloader.
 *
 * NasuaOS-Bootloader is free software: you can redistribute it and/or modify
 ...
 * along with NasuaOS-Bootloader.
 * If not, see <https://www.gnu.org/licenses/>.
 *
 * Modified by Szataki in 2026.
*/
